...
Utilizes a specialized detect\_mode function to classify user queries into domains: Savings, Credit Cards, Loans, or General Finance. This adjusts the system's "persona" and retrieval strategy dynamically.

Context Augmentation (Hybrid RAG):

Internal Retrieval: Queries ChromaDB for specialized financial documents (PDFs).

Grounding Logic: The heuristic\_need\_web module analyzes the internal context. If information is insufficient or outdated, it autonomously spawns a web search task.
